...
for frac_ind,this_frac in ipairs(size_frac) do 
	...
	m:add(nn.Linear(layer_sizes[1],layer_sizes[2])) -- etc
	m:add(nn.PReLU())
	...
	genOutput = true
	run_name = "VanillaNet_PReLU_LearningRate0.05_LayerFrac"..this_frac.."_Epochs"..maxEpoch.."_trainSize"..trainSize.."_Layers"..layer_sizes[1].."-"..layer_sizes[2].."-"..layer_sizes[3] -- <-- UPDATE THIS LINE ON EACH RUN!!!
	if genOutput then
